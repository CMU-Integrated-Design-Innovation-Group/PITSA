...
# Python code file “SBES4G_Server.py” sets up the sampling-based exhaustive 
...
# User needs to enter an interger at this step as the number of sample interval
# in each dimension for the sample-based exhaustive search.
...
def check(x1, x2, x3, x4, res, n):
    ...
    res : cuda array
        This array stores the classification results pf all points.
    n : int
